...
//    rb_hash_aset( shader->vparam, key, Qnil );
    if( TYPE(key) == T_SYMBOL )
    {
        ...
        rb_define_singleton_method( self, rb_id2name( SYM2ID( key ) ), (VALUE (*)(ANYARGS))Shader_ref, 0 );
        rb_define_singleton_method( self, rb_id2name( rb_id_attrset( SYM2ID( key ) ) ), (VALUE (*)(ANYARGS))Shader_set, 1 );
    }
    else if( TYPE(key) == T_STRING )
    {
        rb_hash_aset( shader->vname, ID2SYM(rb_id_attrset(rb_intern( RSTRING_PTR(key) ))), ID2SYM(rb_intern( RSTRING_PTR(key) )) );
        rb_define_singleton_method( self, rb_id2name( rb_intern( RSTRING_PTR(key) ) ), (VALUE (*)(ANYARGS))Shader_ref, 0 );
        rb_define_singleton_method( self, rb_id2name( rb_id_attrset( rb_intern( RSTRING_PTR(key) ) ) ), (VALUE (*)(ANYARGS))Shader_set, 1 );
    }
    return ST_CONTINUE;
}
...
//    hr = CoInitializeEx( NULL, COINIT_MULTITHREADED );
    ...
    /* Windowモジュールにメソッド登録 */
    rb_define_singleton_method( mWindow, "loop"     , (VALUE (*)(ANYARGS))Window_loop       , -1  );
    rb_define_singleton_method( mWindow, "draw"     , (VALUE (*)(ANYARGS))Window_draw       , -1 );
    rb_define_singleton_method( mWindow, "draw_scale", (VALUE (*)(ANYARGS))Window_drawScale  , -1 );
    rb_define_singleton_method( mWindow, "drawScale", (VALUE (*)(ANYARGS))Window_drawScale  , -1 );
    rb_define_singleton_method( mWindow, "draw_rot" , (VALUE (*)(ANYARGS))Window_drawRot    , -1 );
    rb_define_singleton_method( mWindow, "drawRot"  , (VALUE (*)(ANYARGS))Window_drawRot    , -1 );
    rb_define_singleton_method( mWindow, "draw_alpha", (VALUE (*)(ANYARGS))Window_drawAlpha  , -1 );
    rb_define_singleton_method( mWindow, "drawAlpha", (VALUE (*)(ANYARGS))Window_drawAlpha  , -1 );
    rb_define_singleton_method( mWindow, "draw_add" , (VALUE (*)(ANYARGS))Window_drawAdd    , -1 );
    rb_define_singleton_method( mWindow, "drawAdd"  , (VALUE (*)(ANYARGS))Window_drawAdd    , -1 );
    rb_define_singleton_method( mWindow, "draw_sub" , (VALUE (*)(ANYARGS))Window_drawSub    , -1 );
    rb_define_singleton_method( mWindow, "drawSub"  , (VALUE (*)(ANYARGS))Window_drawSub    , -1 );
    rb_define_singleton_method( mWindow, "draw_ex"  , (VALUE (*)(ANYARGS))Window_drawEx     , -1 );
    rb_define_singleton_method( mWindow, "drawEx"   , (VALUE (*)(ANYARGS))Window_drawEx     , -1 );
    rb_define_singleton_method( mWindow, "draw_font", (VALUE (*)(ANYARGS))Window_drawFont   , -1 );
    rb_define_singleton_method( mWindow, "drawFont" , (VALUE (*)(ANYARGS))Window_drawFont   , -1 );
#ifdef DXRUBY15
    rb_define_singleton_method( mWindow, "draw_text", (VALUE (*)(ANYARGS))Window_drawFont   , -1 );
    rb_define_singleton_method( mWindow, "drawText" , (VALUE (*)(ANYARGS))Window_drawFont   , -1 );
#endif
    rb_define_singleton_method( mWindow, "draw_font_ex", (VALUE (*)(ANYARGS))Window_drawFontEx , -1 );
    rb_define_singleton_method( mWindow, "drawFontEx" , (VALUE (*)(ANYARGS))Window_drawFontEx , -1 );
#ifdef DXRUBY15
    rb_define_singleton_method( mWindow, "draw_text_ex", (VALUE (*)(ANYARGS))Window_drawFontEx , -1 );
    rb_define_singleton_method( mWindow, "drawTextEx" , (VALUE (*)(ANYARGS))Window_drawFontEx , -1 );
#endif
    rb_define_singleton_method( mWindow, "draw_tile", (VALUE (*)(ANYARGS))Window_drawTile   , -1  );
    rb_define_singleton_method( mWindow, "drawTile" , (VALUE (*)(ANYARGS))Window_drawTile   , -1  );
#ifdef DXRUBY15
    rb_define_singleton_method( mWindow, "draw_tiles", (VALUE (*)(ANYARGS))Window_drawTile   , -1  );
    rb_define_singleton_method( mWindow, "drawTiles" , (VALUE (*)(ANYARGS))Window_drawTile   , -1  );
#endif
    rb_define_singleton_method( mWindow, "draw_morph", (VALUE (*)(ANYARGS))Window_drawMorph , -1 );
    rb_define_singleton_method( mWindow, "drawMorph" , (VALUE (*)(ANYARGS))Window_drawMorph , -1 );
    rb_define_singleton_method( mWindow, "draw_pixel", (VALUE (*)(ANYARGS))Window_drawPixel , -1 );
    rb_define_singleton_method( mWindow, "drawPixel" , (VALUE (*)(ANYARGS))Window_drawPixel , -1 );
    rb_define_singleton_method( mWindow, "draw_line" , (VALUE (*)(ANYARGS))Window_drawLine , -1 );
    rb_define_singleton_method( mWindow, "drawLine"  , (VALUE (*)(ANYARGS))Window_drawLine , -1 );
    rb_define_singleton_method( mWindow, "draw_box" , (VALUE (*)(ANYARGS))Window_drawBox , -1 );
    rb_define_singleton_method( mWindow, "drawBox"  , (VALUE (*)(ANYARGS))Window_drawBox , -1 );
    rb_define_singleton_method( mWindow, "draw_box_fill" , (VALUE (*)(ANYARGS))Window_drawBoxFill , -1 );
    rb_define_singleton_method( mWindow, "drawBoxFill"  , (VALUE (*)(ANYARGS))Window_drawBoxFill , -1 );
    rb_define_singleton_method( mWindow, "draw_circle", (VALUE (*)(ANYARGS))Window_drawCircle , -1 );
    rb_define_singleton_method( mWindow, "drawCircle" , (VALUE (*)(ANYARGS))Window_drawCircle , -1 );
    rb_define_singleton_method( mWindow, "draw_circle_fill", (VALUE (*)(ANYARGS))Window_drawCircleFill , -1 );
    rb_define_singleton_method( mWindow, "drawCircleFill"  , (VALUE (*)(ANYARGS))Window_drawCircleFill , -1 );
    rb_define_singleton_method( mWindow, "x"        , (VALUE (*)(ANYARGS))Window_x          , 0  );
    rb_define_singleton_method( mWindow, "x="       , (VALUE (*)(ANYARGS))Window_setx       , 1  );
    rb_define_singleton_method( mWindow, "y"        , (VALUE (*)(ANYARGS))Window_y          , 0  );
    rb_define_singleton_method( mWindow, "y="       , (VALUE (*)(ANYARGS))Window_sety       , 1  );
    rb_define_singleton_method( mWindow, "width"    , (VALUE (*)(ANYARGS))Window_width      , 0  );
    rb_define_singleton_method( mWindow, "width="   , (VALUE (*)(ANYARGS))Window_setwidth   , 1  );
    rb_define_singleton_method( mWindow, "height"   , (VALUE (*)(ANYARGS))Window_height     , 0  );
    rb_define_singleton_method( mWindow, "height="  , (VALUE (*)(ANYARGS))Window_setheight  , 1  );
    rb_define_singleton_method( mWindow, "caption"  , (VALUE (*)(ANYARGS))Window_getCaption , 0  );
    rb_define_singleton_method( mWindow, "caption=" , (VALUE (*)(ANYARGS))Window_setCaption , 1  );
    rb_define_singleton_method( mWindow, "scale"    , (VALUE (*)(ANYARGS))Window_getScale   , 0  );
    rb_define_singleton_method( mWindow, "scale="   , (VALUE (*)(ANYARGS))Window_setScale   , 1  );
    rb_define_singleton_method( mWindow, "windowed?", (VALUE (*)(ANYARGS))Window_getwindowed, 0  );
    rb_define_singleton_method( mWindow, "windowed=", (VALUE (*)(ANYARGS))Window_setwindowed, 1  );
    rb_define_singleton_method( mWindow, "full_screen?", (VALUE (*)(ANYARGS))Window_getfullscreen, 0  );
    rb_define_singleton_method( mWindow, "full_screen=", (VALUE (*)(ANYARGS))Window_setfullscreen, 1  );
    rb_define_singleton_method( mWindow, "real_fps" , (VALUE (*)(ANYARGS))Window_getrealfps , 0  );
    rb_define_singleton_method( mWindow, "fps"      , (VALUE (*)(ANYARGS))Window_getfps     , 0  );
    rb_define_singleton_method( mWindow, "fps="     , (VALUE (*)(ANYARGS))Window_setfps     , 1  );
    rb_define_singleton_method( mWindow, "frameskip?"   , (VALUE (*)(ANYARGS))Window_getframeskip, 0  );
    rb_define_singleton_method( mWindow, "frameskip="   , (VALUE (*)(ANYARGS))Window_setframeskip, 1  );
    rb_define_singleton_method( mWindow, "bgcolor"      , (VALUE (*)(ANYARGS))Window_get_bgcolor , 0  );
    rb_define_singleton_method( mWindow, "bgcolor="     , (VALUE (*)(ANYARGS))Window_set_bgcolor , 1  );
    rb_define_singleton_method( mWindow, "min_filter"   , (VALUE (*)(ANYARGS))Window_getMinFilter , 0 );
    rb_define_singleton_method( mWindow, "minFilter"    , (VALUE (*)(ANYARGS))Window_getMinFilter , 0 );
    rb_define_singleton_method( mWindow, "min_filter="  , (VALUE (*)(ANYARGS))Window_setMinFilter , 1 );
    rb_define_singleton_method( mWindow, "minFilter="   , (VALUE (*)(ANYARGS))Window_setMinFilter , 1 );
    rb_define_singleton_method( mWindow, "mag_filter"   , (VALUE (*)(ANYARGS))Window_getMagFilter , 0 );
    rb_define_singleton_method( mWindow, "magFilter"    , (VALUE (*)(ANYARGS))Window_getMagFilter , 0 );
    rb_define_singleton_method( mWindow, "mag_filter="  , (VALUE (*)(ANYARGS))Window_setMagFilter , 1 );
    rb_define_singleton_method( mWindow, "magFilter="   , (VALUE (*)(ANYARGS))Window_setMagFilter , 1 );
    rb_define_singleton_method( mWindow, "get_load"     , (VALUE (*)(ANYARGS))Window_getload, 0  );
    rb_define_singleton_method( mWindow, "getLoad"      , (VALUE (*)(ANYARGS))Window_getload, 0  );
    rb_define_singleton_method( mWindow, "open_filename", (VALUE (*)(ANYARGS))Window_openDialog, 2 );
    rb_define_singleton_method( mWindow, "openFilename" , (VALUE (*)(ANYARGS))Window_openDialog, 2 );
    rb_define_singleton_method( mWindow, "save_filename", (VALUE (*)(ANYARGS))Window_saveDialog, 2 );
    rb_define_singleton_method( mWindow, "saveFilename" , (VALUE (*)(ANYARGS))Window_saveDialog, 2 );
    rb_define_singleton_method( mWindow, "get_screen_shot", (VALUE (*)(ANYARGS))Window_getScreenShot, -1 );
    rb_define_singleton_method( mWindow, "getScreenShot", (VALUE (*)(ANYARGS))Window_getScreenShot, -1 );
    rb_define_singleton_method( mWindow, "create"       , (VALUE (*)(ANYARGS))Window_create , 0 );
    rb_define_singleton_method( mWindow, "close"        , (VALUE (*)(ANYARGS))Window_close , 0 );
    rb_define_singleton_method( mWindow, "created?"     , (VALUE (*)(ANYARGS))Window_get_created , 0 );
    rb_define_singleton_method( mWindow, "closed?"      , (VALUE (*)(ANYARGS))Window_get_closed , 0 );
    rb_define_singleton_method( mWindow, "update"       , (VALUE (*)(ANYARGS))Window_update , 0 );
    rb_define_singleton_method( mWindow, "sync"         , (VALUE (*)(ANYARGS))Window_sync , 0 );
    rb_define_singleton_method( mWindow, "hWnd"         , (VALUE (*)(ANYARGS))Window_gethWnd, 0  );
    rb_define_singleton_method( mWindow, "load_icon"    , (VALUE (*)(ANYARGS))Window_loadIcon, 1  );
    rb_define_singleton_method( mWindow, "loadIcon"     , (VALUE (*)(ANYARGS))Window_loadIcon, 1  );
    rb_define_singleton_method( mWindow, "resize"   , (VALUE (*)(ANYARGS))Window_resize    , 2  );
    rb_define_singleton_method( mWindow, "active?"   , (VALUE (*)(ANYARGS))Window_get_active, 0  );
    rb_define_singleton_method( mWindow, "getScreenModes", (VALUE (*)(ANYARGS))Window_getScreenModes, 0  );
    rb_define_singleton_method( mWindow, "get_screen_modes", (VALUE (*)(ANYARGS))Window_getScreenModes, 0  );
    rb_define_singleton_method( mWindow, "getCurrentMode", (VALUE (*)(ANYARGS))Window_getCurrentMode, 0  );
    rb_define_singleton_method( mWindow, "get_current_mode", (VALUE (*)(ANYARGS))Window_getCurrentMode, 0  );
    rb_define_singleton_method( mWindow, "decide"   , (VALUE (*)(ANYARGS))Window_decide   , 0 );
    rb_define_singleton_method( mWindow, "discard"  , (VALUE (*)(ANYARGS))Window_discard  , 0 );
    rb_define_singleton_method( mWindow, "running_time" , (VALUE (*)(ANYARGS))Window_running_time  , 0 );
    rb_define_singleton_method( mWindow, "runningTime" , (VALUE (*)(ANYARGS))Window_running_time  , 0 );
    rb_define_singleton_method( mWindow, "before_call"    , (VALUE (*)(ANYARGS))Window_before_call, 0 );
    rb_define_singleton_method( mWindow, "after_call"    , (VALUE (*)(ANYARGS))Window_after_call, 0 );
    rb_define_singleton_method( mWindow, "ox"           , (VALUE (*)(ANYARGS))Window_getOx , 0 );
    rb_define_singleton_method( mWindow, "ox="          , (VALUE (*)(ANYARGS))Window_setOx , 1 );
    rb_define_singleton_method( mWindow, "oy"           , (VALUE (*)(ANYARGS))Window_getOy, 0 );
    rb_define_singleton_method( mWindow, "oy="          , (VALUE (*)(ANYARGS))Window_setOy, 1 );
#ifdef DXRUBY15
    rb_define_singleton_method( mWindow, "test_device_lost" , (VALUE (*)(ANYARGS))Window_test_device_lost, 0 );
#endif
//    rb_define_singleton_method( mWindow, "to_image", (VALUE (*)(ANYARGS))Window_to_image, 0 );
//    rb_define_singleton_method( mWindow, "toImage", (VALUE (*)(ANYARGS))Window_to_image, 0 );

    rb_define_singleton_method( mWindow, "draw_shader", (VALUE (*)(ANYARGS))Window_drawShader, -1 );
    rb_define_singleton_method( mWindow, "drawShader" , (VALUE (*)(ANYARGS))Window_drawShader, -1 );


    rb_define_singleton_method( mWindow, "folderDialog" , (VALUE (*)(ANYARGS))Window_folderDialog, -1 );
    rb_define_singleton_method( mWindow, "folder_dialog" , (VALUE (*)(ANYARGS))Window_folderDialog, -1 );

    /* Shaderクラス定義 */
    cShader = rb_define_class_under( mDXRuby, "Shader", rb_cObject );

    /* Shaderクラスにメソッド登録*/
    rb_define_private_method( cShader, "initialize", (VALUE (*)(ANYARGS))Shader_initialize, -1 );
    rb_define_method( cShader, "technique"   , (VALUE (*)(ANYARGS))Shader_getTechnique   , 0 );
    rb_define_method( cShader, "technique="  , (VALUE (*)(ANYARGS))Shader_setTechnique   , 1 );
    ...
    rb_define_private_method( cShaderCore, "initialize", (VALUE (*)(ANYARGS))ShaderCore_initialize, -1 );
    rb_define_method( cShaderCore, "dispose"   , (VALUE (*)(ANYARGS))ShaderCore_dispose, 0 );
    rb_define_method( cShaderCore, "disposed?" , (VALUE (*)(ANYARGS))ShaderCore_check_disposed, 0 );
    rb_define_method( cShaderCore, "param"     , (VALUE (*)(ANYARGS))ShaderCore_getParam  , 0 );
    ...
    rb_define_private_method( cRenderTarget, "initialize", (VALUE (*)(ANYARGS))RenderTarget_initialize, -1 );
    rb_define_method( cRenderTarget, "dispose"   , (VALUE (*)(ANYARGS))RenderTarget_dispose   , 0 );
    rb_define_method( cRenderTarget, "disposed?" , (VALUE (*)(ANYARGS))RenderTarget_check_disposed, 0 );
    rb_define_method( cRenderTarget, "width"     , (VALUE (*)(ANYARGS))RenderTarget_getWidth  , 0 );
    rb_define_method( cRenderTarget, "height"    , (VALUE (*)(ANYARGS))RenderTarget_getHeight , 0 );
    rb_define_method( cRenderTarget, "to_image"  , (VALUE (*)(ANYARGS))RenderTarget_to_image  , 0 );
    rb_define_method( cRenderTarget, "toImage"   , (VALUE (*)(ANYARGS))RenderTarget_to_image  , 0 );
    rb_define_method( cRenderTarget, "resize"    , (VALUE (*)(ANYARGS))RenderTarget_resize    , 2 );

    rb_define_method( cRenderTarget, "draw"     , (VALUE (*)(ANYARGS))RenderTarget_draw       , -1 );
    rb_define_method( cRenderTarget, "draw_scale", (VALUE (*)(ANYARGS))RenderTarget_drawScale  , -1 );
    rb_define_method( cRenderTarget, "drawScale", (VALUE (*)(ANYARGS))RenderTarget_drawScale  , -1 );
    rb_define_method( cRenderTarget, "draw_rot" , (VALUE (*)(ANYARGS))RenderTarget_drawRot    , -1 );
    rb_define_method( cRenderTarget, "drawRot"  , (VALUE (*)(ANYARGS))RenderTarget_drawRot    , -1 );
    rb_define_method( cRenderTarget, "draw_alpha", (VALUE (*)(ANYARGS))RenderTarget_drawAlpha  , -1 );
    rb_define_method( cRenderTarget, "drawAlpha", (VALUE (*)(ANYARGS))RenderTarget_drawAlpha  , -1 );
    rb_define_method( cRenderTarget, "draw_add" , (VALUE (*)(ANYARGS))RenderTarget_drawAdd    , -1 );
    rb_define_method( cRenderTarget, "drawAdd"  , (VALUE (*)(ANYARGS))RenderTarget_drawAdd    , -1 );
    rb_define_method( cRenderTarget, "draw_sub" , (VALUE (*)(ANYARGS))RenderTarget_drawSub    , -1 );
    rb_define_method( cRenderTarget, "drawSub"  , (VALUE (*)(ANYARGS))RenderTarget_drawSub    , -1 );
    rb_define_method( cRenderTarget, "draw_ex"  , (VALUE (*)(ANYARGS))RenderTarget_drawEx     , -1 );
    rb_define_method( cRenderTarget, "drawEx"   , (VALUE (*)(ANYARGS))RenderTarget_drawEx     , -1 );
    rb_define_method( cRenderTarget, "draw_font", (VALUE (*)(ANYARGS))RenderTarget_drawFont   , -1 );
    rb_define_method( cRenderTarget, "drawFont" , (VALUE (*)(ANYARGS))RenderTarget_drawFont   , -1 );
    rb_define_method( cRenderTarget, "draw_font_ex", (VALUE (*)(ANYARGS))RenderTarget_drawFontEx , -1 );
    rb_define_method( cRenderTarget, "drawFontEx" , (VALUE (*)(ANYARGS))RenderTarget_drawFontEx , -1 );
    rb_define_method( cRenderTarget, "draw_text", (VALUE (*)(ANYARGS))RenderTarget_drawFont   , -1 );
    rb_define_method( cRenderTarget, "drawText" , (VALUE (*)(ANYARGS))RenderTarget_drawFont   , -1 );
    rb_define_method( cRenderTarget, "draw_text_ex", (VALUE (*)(ANYARGS))RenderTarget_drawFontEx , -1 );
    rb_define_method( cRenderTarget, "drawTextEx" , (VALUE (*)(ANYARGS))RenderTarget_drawFontEx , -1 );
    rb_define_method( cRenderTarget, "draw_tile", (VALUE (*)(ANYARGS))RenderTarget_drawTile   , -1  );
    rb_define_method( cRenderTarget, "drawTile" , (VALUE (*)(ANYARGS))RenderTarget_drawTile   , -1  );
    rb_define_method( cRenderTarget, "draw_tiles", (VALUE (*)(ANYARGS))RenderTarget_drawTile   , -1  );
    rb_define_method( cRenderTarget, "drawTiles" , (VALUE (*)(ANYARGS))RenderTarget_drawTile   , -1  );
    rb_define_method( cRenderTarget, "draw_morph", (VALUE (*)(ANYARGS))RenderTarget_drawMorph , -1 );
    rb_define_method( cRenderTarget, "drawMorph" , (VALUE (*)(ANYARGS))RenderTarget_drawMorph , -1 );
    rb_define_method( cRenderTarget, "draw_pixel", (VALUE (*)(ANYARGS))RenderTarget_drawPixel , -1 );
    rb_define_method( cRenderTarget, "drawPixel" , (VALUE (*)(ANYARGS))RenderTarget_drawPixel , -1 );
    rb_define_method( cRenderTarget, "draw_line" , (VALUE (*)(ANYARGS))RenderTarget_drawLine , -1 );
    rb_define_method( cRenderTarget, "drawLine"  , (VALUE (*)(ANYARGS))RenderTarget_drawLine , -1 );
    rb_define_method( cRenderTarget, "draw_box" , (VALUE (*)(ANYARGS))RenderTarget_drawBox , -1 );
    rb_define_method( cRenderTarget, "drawBox"  , (VALUE (*)(ANYARGS))RenderTarget_drawBox , -1 );
    rb_define_method( cRenderTarget, "draw_box_fill" , (VALUE (*)(ANYARGS))RenderTarget_drawBoxFill , -1 );
    rb_define_method( cRenderTarget, "drawBoxFill"  , (VALUE (*)(ANYARGS))RenderTarget_drawBoxFill , -1 );
    rb_define_method( cRenderTarget, "draw_circle"  , (VALUE (*)(ANYARGS))RenderTarget_drawCircle , -1 );
    rb_define_method( cRenderTarget, "drawCircle"   , (VALUE (*)(ANYARGS))RenderTarget_drawCircle , -1 );
    rb_define_method( cRenderTarget, "draw_circle_fill", (VALUE (*)(ANYARGS))RenderTarget_drawCircleFill , -1 );
    rb_define_method( cRenderTarget, "drawCircleFill"  , (VALUE (*)(ANYARGS))RenderTarget_drawCircleFill , -1 );
    rb_define_method( cRenderTarget, "update"       , (VALUE (*)(ANYARGS))RenderTarget_update , 0 );
    rb_define_method( cRenderTarget, "bgcolor"      , (VALUE (*)(ANYARGS))RenderTarget_get_bgcolor , 0  );
    rb_define_method( cRenderTarget, "bgcolor="     , (VALUE (*)(ANYARGS))RenderTarget_set_bgcolor , 1  );
    rb_define_method( cRenderTarget, "min_filter"   , (VALUE (*)(ANYARGS))RenderTarget_getMinFilter , 0 );
    rb_define_method( cRenderTarget, "minFilter"    , (VALUE (*)(ANYARGS))RenderTarget_getMinFilter , 0 );
    rb_define_method( cRenderTarget, "min_filter="  , (VALUE (*)(ANYARGS))RenderTarget_setMinFilter , 1 );
    rb_define_method( cRenderTarget, "minFilter="   , (VALUE (*)(ANYARGS))RenderTarget_setMinFilter , 1 );
    rb_define_method( cRenderTarget, "mag_filter"   , (VALUE (*)(ANYARGS))RenderTarget_getMagFilter , 0 );
    rb_define_method( cRenderTarget, "magFilter"    , (VALUE (*)(ANYARGS))RenderTarget_getMagFilter , 0 );
    rb_define_method( cRenderTarget, "mag_filter="  , (VALUE (*)(ANYARGS))RenderTarget_setMagFilter , 1 );
    rb_define_method( cRenderTarget, "magFilter="   , (VALUE (*)(ANYARGS))RenderTarget_setMagFilter , 1 );
    rb_define_method( cRenderTarget, "decide"       , (VALUE (*)(ANYARGS))RenderTarget_decide   , 0 );
    rb_define_method( cRenderTarget, "discard"      , (VALUE (*)(ANYARGS))RenderTarget_discard  , 0 );
    rb_define_method( cRenderTarget, "ox"           , (VALUE (*)(ANYARGS))RenderTarget_getOx , 0 );
    rb_define_method( cRenderTarget, "ox="          , (VALUE (*)(ANYARGS))RenderTarget_setOx , 1 );
    rb_define_method( cRenderTarget, "oy"           , (VALUE (*)(ANYARGS))RenderTarget_getOy, 0 );
    rb_define_method( cRenderTarget, "oy="          , (VALUE (*)(ANYARGS))RenderTarget_setOy, 1 );
#ifdef DXRUBY15
    rb_define_method( cRenderTarget, "regenerate_proc" , (VALUE (*)(ANYARGS))RenderTarget_getRegenerateProc , 0  );
    rb_define_method( cRenderTarget, "regenerate_proc=", (VALUE (*)(ANYARGS))RenderTarget_setRegenerateProc , 1  );
    rb_define_method( cRenderTarget, "regenerateProc" , (VALUE (*)(ANYARGS))RenderTarget_getRegenerateProc , 0  );
    rb_define_method( cRenderTarget, "regenerateProc=", (VALUE (*)(ANYARGS))RenderTarget_setRegenerateProc , 1  );
#endif
    rb_define_method( cRenderTarget, "clear"        , (VALUE (*)(ANYARGS))RenderTarget_clear, 0 );

    rb_define_method( cRenderTarget, "draw_shader", (VALUE (*)(ANYARGS))RenderTarget_drawShader, -1 );
    rb_define_method( cRenderTarget, "drawShader" , (VALUE (*)(ANYARGS))RenderTarget_drawShader, -1 );
