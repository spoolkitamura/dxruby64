...
void Init_dxruby_Sprite()
{
    ...
    rb_define_private_method( cSprite, "initialize", (VALUE (*)(ANYARGS))Sprite_initialize, -1 );
    rb_define_method( cSprite, "x", (VALUE (*)(ANYARGS))Sprite_get_x, 0 );
    rb_define_method( cSprite, "x=", (VALUE (*)(ANYARGS))Sprite_set_x, 1 );
    rb_define_method( cSprite, "y", (VALUE (*)(ANYARGS))Sprite_get_y, 0 );
    rb_define_method( cSprite, "y=", (VALUE (*)(ANYARGS))Sprite_set_y, 1 );
    rb_define_method( cSprite, "z", (VALUE (*)(ANYARGS))Sprite_get_z, 0 );
    rb_define_method( cSprite, "z=", (VALUE (*)(ANYARGS))Sprite_set_z, 1 );
    rb_define_method( cSprite, "angle", (VALUE (*)(ANYARGS))Sprite_get_angle, 0 );
    rb_define_method( cSprite, "angle=", (VALUE (*)(ANYARGS))Sprite_set_angle, 1 );
    rb_define_method( cSprite, "scale_x", (VALUE (*)(ANYARGS))Sprite_get_scale_x, 0 );
    rb_define_method( cSprite, "scale_x=", (VALUE (*)(ANYARGS))Sprite_set_scale_x, 1 );
    rb_define_method( cSprite, "scale_y", (VALUE (*)(ANYARGS))Sprite_get_scale_y, 0 );
    rb_define_method( cSprite, "scale_y=", (VALUE (*)(ANYARGS))Sprite_set_scale_y, 1 );
    rb_define_method( cSprite, "center_x", (VALUE (*)(ANYARGS))Sprite_get_center_x, 0 );
    rb_define_method( cSprite, "center_x=", (VALUE (*)(ANYARGS))Sprite_set_center_x, 1 );
    rb_define_method( cSprite, "center_y", (VALUE (*)(ANYARGS))Sprite_get_center_y, 0 );
    rb_define_method( cSprite, "center_y=", (VALUE (*)(ANYARGS))Sprite_set_center_y, 1 );
    rb_define_method( cSprite, "alpha", (VALUE (*)(ANYARGS))Sprite_get_alpha, 0 );
    rb_define_method( cSprite, "alpha=", (VALUE (*)(ANYARGS))Sprite_set_alpha, 1 );
    rb_define_method( cSprite, "blend", (VALUE (*)(ANYARGS))Sprite_get_blend, 0 );
    rb_define_method( cSprite, "blend=", (VALUE (*)(ANYARGS))Sprite_set_blend, 1 );
    rb_define_method( cSprite, "image", (VALUE (*)(ANYARGS))Sprite_get_image, 0 );
    rb_define_method( cSprite, "image=", (VALUE (*)(ANYARGS))Sprite_set_image, 1 );
    rb_define_method( cSprite, "target", (VALUE (*)(ANYARGS))Sprite_get_target, 0 );
    rb_define_method( cSprite, "target=", (VALUE (*)(ANYARGS))Sprite_set_target, 1 );
    rb_define_method( cSprite, "shader", (VALUE (*)(ANYARGS))Sprite_get_shader, 0 );
    rb_define_method( cSprite, "shader=", (VALUE (*)(ANYARGS))Sprite_set_shader, 1 );
    rb_define_method( cSprite, "collision", (VALUE (*)(ANYARGS))Sprite_get_collision, 0 );
    rb_define_method( cSprite, "collision=", (VALUE (*)(ANYARGS))Sprite_set_collision, 1 );
    rb_define_method( cSprite, "collision_enable", (VALUE (*)(ANYARGS))Sprite_get_collision_enable, 0 );
    rb_define_method( cSprite, "collision_enable=", (VALUE (*)(ANYARGS))Sprite_set_collision_enable, 1 );
    rb_define_method( cSprite, "collision_sync", (VALUE (*)(ANYARGS))Sprite_get_collision_sync, 0 );
    rb_define_method( cSprite, "collision_sync=", (VALUE (*)(ANYARGS))Sprite_set_collision_sync, 1 );
    rb_define_method( cSprite, "visible", (VALUE (*)(ANYARGS))Sprite_get_visible, 0 );
    rb_define_method( cSprite, "visible=", (VALUE (*)(ANYARGS))Sprite_set_visible, 1 );
    rb_define_method( cSprite, "update", (VALUE (*)(ANYARGS))Sprite_update, 0 );
    rb_define_method( cSprite, "draw", (VALUE (*)(ANYARGS))Sprite_draw, 0 );
//    rb_define_method( cSprite, "render", (VALUE (*)(ANYARGS))Sprite_draw, 0 );
    rb_define_method( cSprite, "===", (VALUE (*)(ANYARGS))Sprite_compare, 1 );
    rb_define_method( cSprite, "check", (VALUE (*)(ANYARGS))Sprite_hitcheck, 1 );
    rb_define_method( cSprite, "param_hash", (VALUE (*)(ANYARGS))Sprite_get_param_hash, 0 );
    rb_define_method( cSprite, "vanish", (VALUE (*)(ANYARGS))Sprite_vanish, 0 );
    rb_define_method( cSprite, "vanished?", (VALUE (*)(ANYARGS))Sprite_get_vanish, 0 );
    rb_define_method( cSprite, "offset_sync", (VALUE (*)(ANYARGS))Sprite_get_offset_sync, 0 );
    rb_define_method( cSprite, "offset_sync=", (VALUE (*)(ANYARGS))Sprite_set_offset_sync, 1 );
#ifdef DXRUBY15
    rb_define_method( cSprite, "xy", (VALUE (*)(ANYARGS))Sprite_get_xy, 0 );
    rb_define_method( cSprite, "xy=", (VALUE (*)(ANYARGS))Sprite_set_xy, 1 );
    rb_define_method( cSprite, "xyz", (VALUE (*)(ANYARGS))Sprite_get_xyz, 0 );
    rb_define_method( cSprite, "xyz=", (VALUE (*)(ANYARGS))Sprite_set_xyz, 1 );
#endif

    /* Spriteクラスにメソッド登録 */
    rb_define_singleton_method( cSprite, "check", (VALUE (*)(ANYARGS))Sprite_check, -1 );
    rb_define_singleton_method( cSprite, "update", (VALUE (*)(ANYARGS))Sprite_class_update, 1 );
    rb_define_singleton_method( cSprite, "draw", (VALUE (*)(ANYARGS))Sprite_class_draw, 1 );
//    rb_define_singleton_method( cSprite, "render", (VALUE (*)(ANYARGS))Sprite_class_render, 1 );
    rb_define_singleton_method( cSprite, "clean", (VALUE (*)(ANYARGS))Sprite_class_clean, 1 );
