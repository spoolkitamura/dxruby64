...
void Init_dxruby_Image()
{
    ...
    /* Imageクラスにクラスメソッド登録*/
    rb_define_singleton_method( cImage, "load", (VALUE (*)(ANYARGS))Image_load, -1 );
    rb_define_singleton_method( cImage, "load_to_array", (VALUE (*)(ANYARGS))Image_loadToArray, -1 );
    rb_define_singleton_method( cImage, "loadToArray", (VALUE (*)(ANYARGS))Image_loadToArray, -1 );
    rb_define_singleton_method( cImage, "load_tiles", (VALUE (*)(ANYARGS))Image_loadToArray, -1 );
    rb_define_singleton_method( cImage, "loadTiles", (VALUE (*)(ANYARGS))Image_loadToArray, -1 );
    rb_define_singleton_method( cImage, "create_from_array", (VALUE (*)(ANYARGS))Image_createFromArray, 3 );
    rb_define_singleton_method( cImage, "createFromArray", (VALUE (*)(ANYARGS))Image_createFromArray, 3 );
    rb_define_singleton_method( cImage, "load_from_file_in_memory", (VALUE (*)(ANYARGS))Image_loadFromFileInMemory, 1 );
    rb_define_singleton_method( cImage, "loadFromFileInMemory", (VALUE (*)(ANYARGS))Image_loadFromFileInMemory, 1 );
    rb_define_singleton_method( cImage, "load_from_memory", (VALUE (*)(ANYARGS))Image_loadFromFileInMemory, 1 );
    rb_define_singleton_method( cImage, "loadFromMemory", (VALUE (*)(ANYARGS))Image_loadFromFileInMemory, 1 );
    rb_define_singleton_method( cImage, "perlin_noise", (VALUE (*)(ANYARGS))Image_perlin_noise, -1);
    rb_define_singleton_method( cImage, "octave_perlin_noise", (VALUE (*)(ANYARGS))Image_octave_perlin_noise, -1);
    rb_define_singleton_method( cImage, "custom_perlin_noise", (VALUE (*)(ANYARGS))Image_custom_perlin_noise, -1);
    rb_define_singleton_method( cImage, "perlin_seed", (VALUE (*)(ANYARGS))Image_perlin_seed, 1);

    /* Imageクラスにメソッド登録*/
    rb_define_private_method( cImage, "initialize", (VALUE (*)(ANYARGS))Image_initialize, -1 );
    rb_define_method( cImage, "dispose"   , (VALUE (*)(ANYARGS))Image_dispose   , 0 );
    rb_define_method( cImage, "disposed?" , (VALUE (*)(ANYARGS))Image_check_disposed, 0 );
    rb_define_method( cImage, "delayed_dispose"   , (VALUE (*)(ANYARGS))Image_delayed_dispose   , 0 );
    rb_define_method( cImage, "width"     , (VALUE (*)(ANYARGS))Image_getWidth  , 0 );
    rb_define_method( cImage, "height"    , (VALUE (*)(ANYARGS))Image_getHeight , 0 );
//    rb_define_method( cImage, "width="    , Image_setWidth  , 1 );
//    rb_define_method( cImage, "height="   , Image_setHeight , 1 );
    rb_define_method( cImage, "[]="       , (VALUE (*)(ANYARGS))Image_setPixel  , 3 );
    rb_define_method( cImage, "[]"        , (VALUE (*)(ANYARGS))Image_getPixel  , 2 );
    rb_define_method( cImage, "box"       , (VALUE (*)(ANYARGS))Image_box       , 5 );
    rb_define_method( cImage, "box_fill"  , (VALUE (*)(ANYARGS))Image_boxFill   , 5 );
    rb_define_method( cImage, "boxFill"   , (VALUE (*)(ANYARGS))Image_boxFill   , 5 );
    rb_define_method( cImage, "fill"      , (VALUE (*)(ANYARGS))Image_fill      , 1 );
    rb_define_method( cImage, "clear"     , (VALUE (*)(ANYARGS))Image_clear     , 0 );
    rb_define_method( cImage, "line"      , (VALUE (*)(ANYARGS))Image_line      , 5 );
    rb_define_method( cImage, "triangle"  , (VALUE (*)(ANYARGS))Image_triangle  , 7 );
    rb_define_method( cImage, "triangle_fill", (VALUE (*)(ANYARGS))Image_triangle_fill, 7 );
    rb_define_method( cImage, "triangleFill" , (VALUE (*)(ANYARGS))Image_triangle_fill, 7 );
    rb_define_method( cImage, "circle"    , (VALUE (*)(ANYARGS))Image_circle    , 4 );
    rb_define_method( cImage, "circle_fill", (VALUE (*)(ANYARGS))Image_circleFill, 4 );
    rb_define_method( cImage, "circleFill", (VALUE (*)(ANYARGS))Image_circleFill, 4 );
    rb_define_method( cImage, "compare"   , (VALUE (*)(ANYARGS))Image_compare   , 3 );
    rb_define_method( cImage, "copy_rect" , (VALUE (*)(ANYARGS))Image_copyRect  , -1 );
    rb_define_method( cImage, "copyRect"  , (VALUE (*)(ANYARGS))Image_copyRect  , -1 );
    rb_define_method( cImage, "draw"      , (VALUE (*)(ANYARGS))Image_draw      , -1 );
    rb_define_method( cImage, "draw_font" , (VALUE (*)(ANYARGS))Image_drawFont  , -1 );
    rb_define_method( cImage, "drawFont"  , (VALUE (*)(ANYARGS))Image_drawFont  , -1 );
    rb_define_method( cImage, "save"      , (VALUE (*)(ANYARGS))Image_save      , -1 );
    rb_define_method( cImage, "slice"     , (VALUE (*)(ANYARGS))Image_slice_instance, -1);
    rb_define_method( cImage, "flush"     , (VALUE (*)(ANYARGS))Image_flush, 1);
    rb_define_method( cImage, "set_color_key", (VALUE (*)(ANYARGS))Image_setColorKey , 1 );
    rb_define_method( cImage, "setColorKey", (VALUE (*)(ANYARGS))Image_setColorKey , 1 );
    rb_define_method( cImage, "slice_to_array", (VALUE (*)(ANYARGS))Image_sliceToArray , -1 );
    rb_define_method( cImage, "sliceToArray", (VALUE (*)(ANYARGS))Image_sliceToArray , -1 );
    rb_define_method( cImage, "slice_tiles", (VALUE (*)(ANYARGS))Image_sliceToArray , -1 );
    rb_define_method( cImage, "sliceTiles", (VALUE (*)(ANYARGS))Image_sliceToArray , -1 );
    rb_define_method( cImage, "initialize_copy", (VALUE (*)(ANYARGS))Image_initialize_copy , 1 );
    rb_define_method( cImage, "draw_font_ex" , (VALUE (*)(ANYARGS))Image_drawFontEx  , -1 );
    rb_define_method( cImage, "drawFontEx"   , (VALUE (*)(ANYARGS))Image_drawFontEx  , -1 );
    rb_define_method( cImage, "effect_image_font", (VALUE (*)(ANYARGS))Image_effect, -1);
    rb_define_method( cImage, "effectImageFont", (VALUE (*)(ANYARGS))Image_effect, -1);
    rb_define_method( cImage, "change_hls", (VALUE (*)(ANYARGS))Image_change_hls, -1);
    rb_define_method( cImage, "changeHLS", (VALUE (*)(ANYARGS))Image_change_hls, -1);
