...
void Init_dxruby_Input( void )
{
    ...
    /* Inputモジュールにメソッド登録 */
    rb_define_singleton_method( mInput, "x"              , (VALUE (*)(ANYARGS))Input_x               , -1 );
    rb_define_singleton_method( mInput, "y"              , (VALUE (*)(ANYARGS))Input_y               , -1 );
    rb_define_singleton_method( mInput, "set_mouse_pos"  , (VALUE (*)(ANYARGS))Input_setmousepos     , 2  );
    rb_define_singleton_method( mInput, "setMousePos"    , (VALUE (*)(ANYARGS))Input_setmousepos     , 2  );
    rb_define_singleton_method( mInput, "mouse_pos_x"    , (VALUE (*)(ANYARGS))Input_getmouseposx    , 0  );
    rb_define_singleton_method( mInput, "mousePosX"      , (VALUE (*)(ANYARGS))Input_getmouseposx    , 0  );
    rb_define_singleton_method( mInput, "mouse_pos_y"    , (VALUE (*)(ANYARGS))Input_getmouseposy    , 0  );
    rb_define_singleton_method( mInput, "mousePosY"      , (VALUE (*)(ANYARGS))Input_getmouseposy    , 0  );
    rb_define_singleton_method( mInput, "mouse_x"        , (VALUE (*)(ANYARGS))Input_getmouseposx    , 0  );
    rb_define_singleton_method( mInput, "mouseX"         , (VALUE (*)(ANYARGS))Input_getmouseposx    , 0  );
    rb_define_singleton_method( mInput, "mouse_y"        , (VALUE (*)(ANYARGS))Input_getmouseposy    , 0  );
    rb_define_singleton_method( mInput, "mouseY"         , (VALUE (*)(ANYARGS))Input_getmouseposy    , 0  );
    rb_define_singleton_method( mInput, "key_down?"      , (VALUE (*)(ANYARGS))Input_keyDown         , 1  );
    rb_define_singleton_method( mInput, "keyDown?"       , (VALUE (*)(ANYARGS))Input_keyDown         , 1  );
    rb_define_singleton_method( mInput, "key_push?"      , (VALUE (*)(ANYARGS))Input_keyPush         , 1  );
    rb_define_singleton_method( mInput, "keyPush?"       , (VALUE (*)(ANYARGS))Input_keyPush         , 1  );
    rb_define_singleton_method( mInput, "key_release?"   , (VALUE (*)(ANYARGS))Input_keyRelease      , 1  );
    rb_define_singleton_method( mInput, "keyRelease?"    , (VALUE (*)(ANYARGS))Input_keyRelease      , 1  );
    rb_define_singleton_method( mInput, "pad_down?"      , (VALUE (*)(ANYARGS))Input_padDown         , -1 );
    rb_define_singleton_method( mInput, "padDown?"       , (VALUE (*)(ANYARGS))Input_padDown         , -1 );
    rb_define_singleton_method( mInput, "pad_push?"      , (VALUE (*)(ANYARGS))Input_padPush         , -1 );
    rb_define_singleton_method( mInput, "padPush?"       , (VALUE (*)(ANYARGS))Input_padPush         , -1 );
    rb_define_singleton_method( mInput, "pad_release?"   , (VALUE (*)(ANYARGS))Input_padRelease      , -1 );
    rb_define_singleton_method( mInput, "padRelease?"    , (VALUE (*)(ANYARGS))Input_padRelease      , -1 );
    rb_define_singleton_method( mInput, "mouse_down?"    , (VALUE (*)(ANYARGS))Input_mouseDown       , 1  );
    rb_define_singleton_method( mInput, "mouseDown?"     , (VALUE (*)(ANYARGS))Input_mouseDown       , 1  );
    rb_define_singleton_method( mInput, "mouse_push?"    , (VALUE (*)(ANYARGS))Input_mousePush       , 1  );
    rb_define_singleton_method( mInput, "mousePush?"     , (VALUE (*)(ANYARGS))Input_mousePush       , 1  );
    rb_define_singleton_method( mInput, "mouse_release?" , (VALUE (*)(ANYARGS))Input_mouseRelease    , 1  );
    rb_define_singleton_method( mInput, "mouseRelease?"  , (VALUE (*)(ANYARGS))Input_mouseRelease    , 1  );
    rb_define_singleton_method( mInput, "mouse_enable="  , (VALUE (*)(ANYARGS))Input_enablemouse     , 1  );
    rb_define_singleton_method( mInput, "mouseEnable="   , (VALUE (*)(ANYARGS))Input_enablemouse     , 1  );
    rb_define_singleton_method( mInput, "mouse_wheel_pos", (VALUE (*)(ANYARGS))Input_getmousewheelpos, 0  );
    rb_define_singleton_method( mInput, "mouseWheelPos"  , (VALUE (*)(ANYARGS))Input_getmousewheelpos, 0  );
    rb_define_singleton_method( mInput, "mouse_wheel_pos=", (VALUE (*)(ANYARGS))Input_setmousewheelpos, 1  );
    rb_define_singleton_method( mInput, "mouseWheelPos=" , (VALUE (*)(ANYARGS))Input_setmousewheelpos, 1  );
    rb_define_singleton_method( mInput, "set_config"     , (VALUE (*)(ANYARGS))Input_setconfig       , -1 );
    rb_define_singleton_method( mInput, "setConfig"      , (VALUE (*)(ANYARGS))Input_setconfig       , -1 );
    rb_define_singleton_method( mInput, "set_repeat"     , (VALUE (*)(ANYARGS))Input_setrepeat       , 2  );
    rb_define_singleton_method( mInput, "setRepeat"      , (VALUE (*)(ANYARGS))Input_setrepeat       , 2  );
    rb_define_singleton_method( mInput, "update"         , (VALUE (*)(ANYARGS))Input_update          , 0  );
    rb_define_singleton_method( mInput, "set_key_repeat" , (VALUE (*)(ANYARGS))Input_setkeyrepeat    , 3  );
    rb_define_singleton_method( mInput, "setKeyRepeat"   , (VALUE (*)(ANYARGS))Input_setkeyrepeat    , 3  );
    rb_define_singleton_method( mInput, "set_pad_repeat" , (VALUE (*)(ANYARGS))Input_setpadrepeat    , -1 );
    rb_define_singleton_method( mInput, "setPadRepeat"   , (VALUE (*)(ANYARGS))Input_setpadrepeat    , -1 );
    rb_define_singleton_method( mInput, "keys"           , (VALUE (*)(ANYARGS))Input_getKeys         , 0  );
    rb_define_singleton_method( mInput, "pads"           , (VALUE (*)(ANYARGS))Input_getPads         , -1 );
    rb_define_singleton_method( mInput, "pad_num"        , (VALUE (*)(ANYARGS))Input_getPadNum       , 0  );
    rb_define_singleton_method( mInput, "requested_close?", (VALUE (*)(ANYARGS))Input_requested_close, 0  );

    rb_define_singleton_method( mInput, "pad_axis"       , (VALUE (*)(ANYARGS))Input_getPadAxis      , -1 );
    rb_define_singleton_method( mInput, "pad_lstick"     , (VALUE (*)(ANYARGS))Input_getPadLStick    , -1 );
    rb_define_singleton_method( mInput, "pad_rstick"     , (VALUE (*)(ANYARGS))Input_getPadRStick    , -1 );
    rb_define_singleton_method( mInput, "pad_pov"        , (VALUE (*)(ANYARGS))Input_getPadPov       , -1 );
//    rb_define_singleton_method( mInput, "start"        , Input_ff_start        , 0 );
//    rb_define_singleton_method( mInput, "stop"        , Input_ff_stop        , 0 );

    /* 右スティックと十字ボタンのメソッド追加*/
    rb_define_singleton_method( mInput, "pad_lx"             , (VALUE (*)(ANYARGS))Input_lx              , -1 );
    rb_define_singleton_method( mInput, "pad_ly"             , (VALUE (*)(ANYARGS))Input_ly              , -1 );
    rb_define_singleton_method( mInput, "pad_rx"             , (VALUE (*)(ANYARGS))Input_rx              , -1 );
    rb_define_singleton_method( mInput, "pad_ry"             , (VALUE (*)(ANYARGS))Input_ry              , -1 );
    rb_define_singleton_method( mInput, "pad_pov_x"          , (VALUE (*)(ANYARGS))Input_dx              , -1 );
    rb_define_singleton_method( mInput, "pad_pov_y"          , (VALUE (*)(ANYARGS))Input_dy              , -1 );
    rb_define_singleton_method( mInput, "set_cursor"         , (VALUE (*)(ANYARGS))Input_setCursor       , 1 );
