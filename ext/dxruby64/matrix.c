...
void Init_dxruby_Matrix()
{
    ...
    /* Matrixクラスにクラスメソッド登録*/
    rb_define_singleton_method( cMatrix, "look_at", (VALUE (*)(ANYARGS))Matrix_look_at, 3 );
    rb_define_singleton_method( cMatrix, "lookAt", (VALUE (*)(ANYARGS))Matrix_look_at, 3 );
    rb_define_singleton_method( cMatrix, "projection", (VALUE (*)(ANYARGS))Matrix_create_projection, 4 );
    rb_define_singleton_method( cMatrix, "projection_fov", (VALUE (*)(ANYARGS))Matrix_create_projection_fov, 4 );
    rb_define_singleton_method( cMatrix, "projectionFov", (VALUE (*)(ANYARGS))Matrix_create_projection_fov, 4 );
    rb_define_singleton_method( cMatrix, "projection_ortho", (VALUE (*)(ANYARGS))Matrix_create_projection_ortho, 4 );
    rb_define_singleton_method( cMatrix, "projectionOrtho", (VALUE (*)(ANYARGS))Matrix_create_projection_ortho, 4 );
    rb_define_singleton_method( cMatrix, "rotation", (VALUE (*)(ANYARGS))Matrix_create_rot, 1 );
    rb_define_singleton_method( cMatrix, "rotation_x", (VALUE (*)(ANYARGS))Matrix_create_rot_x, 1 );
    rb_define_singleton_method( cMatrix, "rotationX", (VALUE (*)(ANYARGS))Matrix_create_rot_x, 1 );
    rb_define_singleton_method( cMatrix, "rotation_y", (VALUE (*)(ANYARGS))Matrix_create_rot_y, 1 );
    rb_define_singleton_method( cMatrix, "rotationY", (VALUE (*)(ANYARGS))Matrix_create_rot_y, 1 );
    rb_define_singleton_method( cMatrix, "rotation_z", (VALUE (*)(ANYARGS))Matrix_create_rot_z, 1 );
    rb_define_singleton_method( cMatrix, "rotationZ", (VALUE (*)(ANYARGS))Matrix_create_rot_z, 1 );
    rb_define_singleton_method( cMatrix, "scaling", (VALUE (*)(ANYARGS))Matrix_create_scale, -1 );
    rb_define_singleton_method( cMatrix, "translation", (VALUE (*)(ANYARGS))Matrix_create_trans, -1 );

    /* Matrixクラスにインスタンスメソッド登録*/
    rb_define_private_method( cMatrix, "initialize", (VALUE (*)(ANYARGS))Matrix_initialize, -1 );
    rb_define_method( cMatrix, "*", (VALUE (*)(ANYARGS))Matrix_mul, 1 );
    rb_define_method( cMatrix, "to_s", (VALUE (*)(ANYARGS))Matrix_to_s, 0 );
    rb_define_method( cMatrix, "to_a", (VALUE (*)(ANYARGS))Matrix_to_a, 0 );
    rb_define_method( cMatrix, "inverse", (VALUE (*)(ANYARGS))Matrix_inverse, 0 );
    ...
    /* Vectorクラスにクラスメソッド登録*/
    rb_define_singleton_method( cVector, "distance", (VALUE (*)(ANYARGS))Vector_distance, 2 );
    rb_define_singleton_method( cVector, "cross_product", (VALUE (*)(ANYARGS))Vector_cross_product, 2 );
    rb_define_singleton_method( cVector, "crossProduct", (VALUE (*)(ANYARGS))Vector_cross_product, 2 );
    rb_define_singleton_method( cVector, "dot_product", (VALUE (*)(ANYARGS))Vector_dot_product, 2 );
    rb_define_singleton_method( cVector, "dotProduct", (VALUE (*)(ANYARGS))Vector_dot_product, 2 );

    /* Vectorクラスにインスタンスメソッド登録*/
    rb_define_private_method( cVector, "initialize", (VALUE (*)(ANYARGS))Vector_initialize, -1 );
    rb_define_method( cVector, "*", (VALUE (*)(ANYARGS))Vector_mul, 1 );
    rb_define_method( cVector, "+", (VALUE (*)(ANYARGS))Vector_add, 1 );
    rb_define_method( cVector, "-", (VALUE (*)(ANYARGS))Vector_sub, 1 );
    rb_define_method( cVector, "-@", (VALUE (*)(ANYARGS))Vector_minus, 0 );
    rb_define_method( cVector, "/", (VALUE (*)(ANYARGS))Vector_div, 1 );
    rb_define_method( cVector, "to_s", (VALUE (*)(ANYARGS))Vector_to_s, 0 );
    rb_define_method( cVector, "to_a", (VALUE (*)(ANYARGS))Vector_to_a, 0 );
    rb_define_method( cVector, "x", (VALUE (*)(ANYARGS))Vector_get_x, 0 );
    rb_define_method( cVector, "y", (VALUE (*)(ANYARGS))Vector_get_y, 0 );
    rb_define_method( cVector, "z", (VALUE (*)(ANYARGS))Vector_get_z, 0 );
    rb_define_method( cVector, "w", (VALUE (*)(ANYARGS))Vector_get_w, 0 );
    rb_define_method( cVector, "xy", (VALUE (*)(ANYARGS))Vector_get_xy, 0 );
    rb_define_method( cVector, "xyz", (VALUE (*)(ANYARGS))Vector_get_xyz, 0 );
    rb_define_method( cVector, "size", (VALUE (*)(ANYARGS))Vector_get_size, 0 );
    rb_define_method( cVector, "normalize", (VALUE (*)(ANYARGS))Vector_normalize, 0 );
    rb_define_method( cVector, "==", (VALUE (*)(ANYARGS))Vector_equal, 1 );
    rb_define_method( cVector, "translate", (VALUE (*)(ANYARGS))Vector_translate, -1 );
    rb_define_method( cVector, "rotate", (VALUE (*)(ANYARGS))Vector_rotate, -1 );
    rb_define_method( cVector, "rotate_x", (VALUE (*)(ANYARGS))Vector_rotate_x, 1 );
    rb_define_method( cVector, "rotateX", (VALUE (*)(ANYARGS))Vector_rotate_x, 1 );
    rb_define_method( cVector, "rotate_y", (VALUE (*)(ANYARGS))Vector_rotate_y, 1 );
    rb_define_method( cVector, "rotateY", (VALUE (*)(ANYARGS))Vector_rotate_y, 1 );
    rb_define_method( cVector, "rotate_z", (VALUE (*)(ANYARGS))Vector_rotate_z, 1 );
    rb_define_method( cVector, "rotateZ", (VALUE (*)(ANYARGS))Vector_rotate_z, 1 );
    rb_define_method( cVector, "angle_to", (VALUE (*)(ANYARGS))Vector_angle_to, 1 );
    rb_define_method( cVector, "angleTo", (VALUE (*)(ANYARGS))Vector_angle_to, 1 );
