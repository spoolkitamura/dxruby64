...
void Init_dxruby_Font()
{
    ...
    /* Fontクラスにクラスメソッド登録*/
    rb_define_singleton_method( cFont, "install", (VALUE (*)(ANYARGS))Font_install, 1 );
    rb_define_singleton_method( cFont, "default", (VALUE (*)(ANYARGS))Font_get_default, 0 );
    rb_define_singleton_method( cFont, "default=", (VALUE (*)(ANYARGS))Font_set_default, 1 );

    /* Fontクラスにメソッド登録*/
    rb_define_private_method( cFont, "initialize", (VALUE (*)(ANYARGS))Font_initialize, -1 );
    rb_define_method( cFont, "dispose"   , (VALUE (*)(ANYARGS))Font_dispose   , 0 );
    rb_define_method( cFont, "disposed?" , (VALUE (*)(ANYARGS))Font_check_disposed, 0 );
    rb_define_method( cFont, "get_width" , (VALUE (*)(ANYARGS))Font_getWidth  , 1 );
    rb_define_method( cFont, "getWidth"  , (VALUE (*)(ANYARGS))Font_getWidth  , 1 );
    rb_define_method( cFont, "fontname", (VALUE (*)(ANYARGS))Font_getFontname  , 0 );
    rb_define_method( cFont, "name", (VALUE (*)(ANYARGS))Font_getName  , 0 );
    rb_define_method( cFont, "italic", (VALUE (*)(ANYARGS))Font_getItalic  , 0 );
    rb_define_method( cFont, "weight" , (VALUE (*)(ANYARGS))Font_getWeight  , 0 );
    rb_define_method( cFont, "auto_fitting" , (VALUE (*)(ANYARGS))Font_getAutoFitting , 0 );
    rb_define_method( cFont, "size"      , (VALUE (*)(ANYARGS))Font_getSize  , 0 );
    rb_define_method( cFont, "info"      , (VALUE (*)(ANYARGS))Font_getInfo  , 1 );
